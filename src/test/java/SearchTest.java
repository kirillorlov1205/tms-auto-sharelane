...
public class SearchTest {
    ...
    public void verifySearchingByOneWordBookName() {
        ...
        Assert.assertTrue(driver.findElement(By.xpath("//p[text()='Gitanjali ']")).isDisplayed());
    }
    ...
    public void verifySearchingByMultipleWordsBookName() {
        ...
        driver.findElement(Constants.SEARCH_BUTTON).click();
        Assert.assertTrue(driver.findElement(By.xpath("//p[text()='The Power of Positive Thinking ']"))
                .isDisplayed());
    }
